...
public class CareEventController {
    ...
    public ResponseEntity<List<CareEventResponse>> list(Authentication authentication) {
    ...
    public ResponseEntity<CareEventResponse> get(
        ...
        return ResponseEntity.ok(careEventService.getEvent(id, user));
    }
    ...
    public ResponseEntity<CareEventResponse> ack(
        ...
        Authentication authentication) {
        User user = getUserByAuth(authentication);
        return ResponseEntity.ok(careEventService.ackEvent(id, user));
    }
}